...
"""
Creates a machine learning model for predicting breast cancer using a public dataset.
...
input = dataset.drop("diagnosis", axis=1)     # Drop the Outcome column
output = dataset["diagnosis"]                 # Select only the Outcome column
...
model.save("saved/cancer_model.h5")
